...
-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_PRCS_I::ole
CREATE INDEX OLE_NG_BAT_PRCS_I ON OLE_NG_BAT_PRCS_JOB_T(PRF_ID)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_I', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 24, '7:7437bd2664f4e702cd99fd052f8fa373', 'createIndex', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_DETAILS_T', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 25, '7:b6c4509ac50869d75760e8a7f545d29b', 'createTable', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_DETAILS_S', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 26, '7:9af29a082688e7225d21cd14a198ec46', 'createSequence', '', 'EXECUTED', '3.2.0')
/

-- Changeset org/kuali/ole/2.1/db.changelog-20151123.xml::OLE_NG_BAT_JOB_I::ole
CREATE INDEX OLE_NG_BAT_JOB_I ON OLE_NG_BAT_JOB_DETAILS_T(JOB_ID)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_JOB_I', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 27, '7:05f1c45a24042adb2e34bec4976eb6a8', 'createIndex', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRF_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 28, '7:85d85111e729dc5d2177122b215e606e', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_NG_BAT_PRCS_ID_FK', 'ole', 'org/kuali/ole/2.1/db.changelog-20151123.xml', SYSTIMESTAMP, 29, '7:ca9b264632f1bdf7b3e6b244502bc67a', 'addForeignKeyConstraint', '', 'EXECUTED', '3.2.0')
/
